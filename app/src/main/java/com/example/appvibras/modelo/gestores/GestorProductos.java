...
public class GestorProductos {
    ...
    public boolean agregarProducto(String nombre, String descripcion, double precio, int idCategoria) {
        if (nombre == null || nombre.trim().isEmpty() || precio < 0) return false;
        
        Producto nuevo = new Producto(nombre, descripcion, precio, 0, idCategoria);
